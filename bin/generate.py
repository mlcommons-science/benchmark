...
if __name__ == "__main__":
    ...
    parser.add_argument('--index', action='store_true',
                        help="Generate individual markdown files and an index.md page.")
    ...
    if args.index:
        write_individual_md_pages(args.files, os.path.join(args.out_dir, "md"), columns)
    if args.format == 'md':
