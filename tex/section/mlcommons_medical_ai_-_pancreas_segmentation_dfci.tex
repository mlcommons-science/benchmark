\subsection{MLCommons Medical AI - Pancreas Segmentation (DFCI)}
{{\footnotesize
...
\includegraphics[width=0.2\textwidth]{mlcommons_medical_ai_-_pancreas_segmentation_dfci_radar.pdf}
}}
\clearpage