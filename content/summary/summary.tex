...
\includegraphics[width=0.2333\textwidth]{HDR ML Anomaly Challenge- Sea Level Rise_radar.pdf}
\includegraphics[width=0.2333\textwidth]{Single Qubit Readout on QICK System_radar.pdf}
\\[1ex]
\includegraphics[width=0.2333\textwidth]{GPQA A Graduate Level Google Proof Question and Answer Benchmark_radar.pdf}
