...
class Evaluate:
    ...
    def plot_radar_charts(self, fmt, output_dir, font_size=18):
        ...
        for i, entry in enumerate(self.entries):
            ...
            filename = f"{id}_radar{fmt}"

            Console.Error("DDDDDD: " + filename)  # Debugging line
...
if __name__ == "__main__":
    ...
    pprint(evaluator.entries)  # Debugging line
