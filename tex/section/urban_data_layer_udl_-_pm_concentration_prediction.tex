\subsection{Urban Data Layer (UDL) - PM2.5 Concentration Prediction}
{{\footnotesize
...
\includegraphics[width=0.2\textwidth]{urban_data_layer_udl_-_pm_concentration_prediction_radar.pdf}
}}
\clearpage