\subsection{Urban Data Layer (UDL) - El Nino Anomaly Detection}
{{\footnotesize
...
\includegraphics[width=0.2\textwidth]{urban_data_layer_udl_-_el_nino_anomaly_detection_radar.pdf}
}}
\clearpage