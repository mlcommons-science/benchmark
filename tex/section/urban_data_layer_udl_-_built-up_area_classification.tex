\subsection{Urban Data Layer (UDL) - Built-up Area Classification}
{{\footnotesize
...
\includegraphics[width=0.2\textwidth]{urban_data_layer_udl_-_built-up_area_classification_radar.pdf}
}}
\clearpage